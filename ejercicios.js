...
function logVersion() {
    const mensaje1 = 'La versión de JavaScript es:' ;
    const version = 2024 ;
    console.log(mensaje1, version);
}


//Llamar a todas las funciones para que se ejecuten
    compareTenAndNine();
    compareZeroAndZero();
    compareSeven();
    canBuyProduct();
